...
public class DebugTab : Tab
{
    ...
    public override unsafe void Draw()
    {
        ...
        ImGui.Text("Set");
        ImGui.Indent();
        ImGui.InputInt("DutyCategory", ref _dutyCategory);
        if (ImGui.Button("Set DutyCategory"))
            storedInfo->SelectedCategory = (ushort)_dutyCategory;
        ImGui.InputInt("DutyID", ref _dutyId);
        if (ImGui.Button("Set DutyID"))
            storedInfo->SelectedDutyId = (ushort)_dutyId;
    }
}